...
- [x] B1d. Remediate review finding: restrict lazy era-art caching to the exact scope-relative `assets/eras/` prefix; prove near-match paths do not open or write the active era-art cache.
