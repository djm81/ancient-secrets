...
|---|---|---|---|
| RI-001 contextual actions preserve complete action access | unit + browser | `tests/responsive-investigative-surface.test.js`: 2/2 passed on 2026-07-21 | automated pass; manual pending |
| RI-002 four explicit responsive modes | browser matrix + manual | `RI-002 and RI-003` Playwright test: phone portrait, phone landscape, desktop portrait, desktop landscape passed on 2026-07-21 | automated pass; device matrix pending |
| RI-003 rotation and resize preserve play state and focus | browser + manual device | `RI-002 and RI-003` Playwright test: selected mirror and Casebook focus survived portrait → landscape on 2026-07-21 | automated pass; device matrix pending |
