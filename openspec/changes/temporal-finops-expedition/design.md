...
|---|---|---|---|---|---|
| 1 | **Babylon, ~1750 BCE** — temple scribe of Esagila | Cuneiform grain/silver ledgers; Code of Hammurabi interest caps (silver 20%, grain 33⅓%) | Reconcile a temple grain ledger: inspect sealed deliveries against a damp tablet, flag its anomalous line, establish the corrected total, then apply the public silver rule before sealing the entry | Data Ingestion, Allocation, Anomaly Management; Governance/Policy (law-bound rates) | Anemometer |
