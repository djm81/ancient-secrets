...
- Add a data-driven **era expedition engine** and seven authored eras (Babylon, Egypt, Athens, Rome, Champagne Fairs/Templars, Florence 1494, and "The Age to Come"), each with an explorable scene, an era mentor, clue artifacts, and one deterministic financial trial built from that era's real instruments. Babylon’s first slice presents its reconciliation as a staged evidence-led audit, rather than an opaque pair of dropdowns.
